...
export function ProductBarcodeScanner({
	...
	const isLoading = isLoadingProduct || isLoadingOrder;
		...
		<Dialog open={isOpen} onOpenChange={handleOpenChange}>
			...
			<DialogContent className="max-w-md mx-auto">
				<DialogHeader>
					...
					<DialogDescription>
						Busca productos por código de barras o facturas por ID
					</DialogDescription>
				</DialogHeader>
						...
						{isLoading && (
							...
							>
								...
								<p className="text-sm text-muted-foreground mt-2">
									{currentSearchType === "product" ? "Buscando producto" : "Buscando factura"}
								</p>
							</motion.div>
						)}
						...
						{error && (
							...
							>
								...
								<p className="text-sm text-destructive">
									{currentSearchType === "product" ? "Error al buscar producto." : "Error al buscar factura."}
								</p>
							</motion.div>
						)}

						{!isLoading && !error && barcodeInput && !product && !order && (
							<motion.div
								initial={{ opacity: 0, y: 10 }}
								animate={{ opacity: 1, y: 0 }}
								exit={{ opacity: 0, y: -10 }}
							...
							>
								...
								<p className="text-sm text-muted-foreground">
									No se encontró ningún {currentSearchType === "product" ? "producto" : "factura"} 
